...
export function DataCard({ item, onEdit, onDelete }: DataCardProps) {
  ...
  const renderContextCard = () => (
    <Card className="bg-sidebar-accent border-sidebar-border hover:border-sidebar-foreground/20 transition-all duration-200 cursor-pointer overflow-hidden">
      <div className="p-3 sm:p-4 space-y-3 sm:space-y-4">
        ...
        {/* Title */}
        <h3 className="text-base sm:text-lg font-semibold text-sidebar-foreground line-clamp-2 sm:line-clamp-3 leading-tight">
          {item.title}
        </h3>
  ...
  const renderIssueCard = () => {
    ...
    const priority = getPriorityFromMetadata(item.metadata)
      ...
      <div className="p-3 sm:p-4 space-y-3 sm:space-y-4">
        ...
        <div className="flex items-start justify-between gap-2 sm:gap-3">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              <h3 className="text-base sm:text-lg font-semibold text-sidebar-foreground line-clamp-1 sm:line-clamp-2 leading-tight">
                {item.title}
              </h3>
